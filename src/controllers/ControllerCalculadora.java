...
public class ControllerCalculadora  implements ActionListener  {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        modelCalculadora.setNumero1(Integer.valueOf(viewCalculadora.jtf_numero1.getText()));
        modelCalculadora.setNumero2(Integer.valueOf(viewCalculadora.jtf_numero2.getText()));
